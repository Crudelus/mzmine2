...
public class MassListExporterParameters extends SimpleParameterSet {
    ...
    public static final DirectoryParameter targetDirectory = new DirectoryParameter(
            "Mass List Target Folder",
    ...
    public static final MassListParameter massList = getMassListParameterWithDefault();
   ...
   private static MassListParameter getMassListParameterWithDefault() {
        var massListParameter = new MassListParameter();
        massListParameter.setValue("masses");   
        return massListParameter;
   }
}
